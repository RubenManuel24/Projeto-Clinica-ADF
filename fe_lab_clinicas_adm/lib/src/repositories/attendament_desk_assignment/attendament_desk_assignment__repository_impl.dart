...
class AttendamentDeskAssignmentRepositoryImpl
    implements AttendamentDeskAssignmentRepository {
  final RestClient restClient;
  AttendamentDeskAssignmentRepositoryImpl({
  ...
  Future<Either<RepositoryException, Unit>> _clearDeskByUser() async {
    try {
      ...
      log('Erro ao deletar número do guiche', error: e, stackTrace: s);

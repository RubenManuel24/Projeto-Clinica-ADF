...
import 'package:fe_lab_clinicas_self_service/src/repositories/documents/documents_repositoryImpl.dart';
...
class DocumentsScanConfirmRouter extends FlutterGetItModulePageRouter {
  ...
  List<Bind<Object>> get bindings => [
    Bind.lazySingleton<DocumentsRepository>((i) => DocumentsRepositoryImpl(restClient: i())),

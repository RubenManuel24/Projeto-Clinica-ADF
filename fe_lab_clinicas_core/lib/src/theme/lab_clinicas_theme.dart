...
final class LabClinicasTheme {
  ...
  static final lightTheme = ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
          ...
          labelStyle: const TextStyle(
              fontSize: 14, color: orangeColor, fontWeight: FontWeight.w700),
          floatingLabelStyle:
  ...
  static final titleStyle =
      const TextStyle(color: blueColor, fontSize: 32, fontWeight: FontWeight.w900);

  static final titleSmalltyle =
      TextStyle(color: blueColor, fontSize: 24, fontWeight: FontWeight.w900);

  static final subTitleSmallStyle =
